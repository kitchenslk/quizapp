 ...
 * Project	: quizapp
 */
public class GameRoundUserGroupUserIdGenerator implements IdentifierGenerator{
...
private Log logger = LogFactory.getLog(this.getClass());
	...
	public Serializable generate(SessionImplementor session, Object object)
        ...
        try {
            ...
            PreparedStatement ps = connection.prepareStatement("SELECT nextval ('game_round_user_group_user_id') as nextval");
