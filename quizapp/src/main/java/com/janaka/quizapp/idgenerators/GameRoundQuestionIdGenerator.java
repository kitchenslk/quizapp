 ...
 * Project	: quizapp
 */
public class GameRoundQuestionIdGenerator implements IdentifierGenerator{
...
private Log logger = LogFactory.getLog(this.getClass());
	...
	public Serializable generate(SessionImplementor session, Object object)
        ...
        try {
            ...
            PreparedStatement ps = connection.prepareStatement("SELECT nextval (game_round_question_id') as nextval");
