 ...
 * Project	: quizapp
 */
public class UploadedFileIdGenerator implements IdentifierGenerator{
...
private Log logger = LogFactory.getLog(this.getClass());
	...
	public Serializable generate(SessionImplementor session, Object object)
        ...
        try {
            ...
            PreparedStatement ps = connection.prepareStatement("SELECT nextval ('uploaded_file_id') as nextval");
